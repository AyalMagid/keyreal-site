...
const PLAN_FAQ = [
  ...
  },
  {
    ...
    a: "מי שרכש תקופות שירות בתשלום בהיקף מצטבר של 60 ימים לפחות ועדיין לא מצא דירה, זכאי לפי בקשתו ל-30 ימי שירות נוספים ללא עלות. ההטבה חלה על תשלומים מ-25.8.2026, ניתנת פעם אחת למשתמש, ויש לפנות בתוך 14 ימים מתום התקופה."
  },
  {
